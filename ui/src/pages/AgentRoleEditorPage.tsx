      ...
      <div className="flex-1 overflow-y-auto p-5">
        ...
        <div className="max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                data-testid="agent-role-editor-id-input"
            ...
            <div>
              ...
              <input
                ...
                data-testid="agent-role-editor-name-input"
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              data-testid="agent-role-editor-prompt-textarea"
              rows={32}
        ...
        <div className="max-w-6xl flex items-center justify-end gap-3 mt-5">
          ...
          <button
            ...
            data-testid="agent-role-editor-save-btn"
